...
export declare class ComplianceApiRequestFactory extends BaseAPIRequestFactory {
    getRuleBasedView(to: number, framework?: string, version?: string, queryFindingsWithoutFrameworkVersion?: boolean, includeRulesWithoutFindings?: boolean, isCustom?: boolean, query?: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class ComplianceApiResponseProcessor {
    /**
     ...
     */
    getRuleBasedView(response: ResponseContext): Promise<RuleBasedViewResponse>;
}
...
export declare class ComplianceApi {
    ...
    constructor(configuration: Configuration, requestFactory?: ComplianceApiRequestFactory, responseProcessor?: ComplianceApiResponseProcessor);
    /**
     ...
     */
    getRuleBasedView(param: ComplianceApiGetRuleBasedViewRequest, options?: Configuration): Promise<RuleBasedViewResponse>;
}
