...
export declare class StorageManagementApiRequestFactory extends BaseAPIRequestFactory {
    upsertSyncConfig(body: UpsertCloudInventorySyncConfigRequest, _options?: Configuration): Promise<RequestContext>;
}
export declare class StorageManagementApiResponseProcessor {
    /**
     ...
     */
    upsertSyncConfig(response: ResponseContext): Promise<CloudInventorySyncConfigResponse>;
}
...
export declare class StorageManagementApi {
    private requestFactory;
    private responseProcessor;
    private configuration;
    constructor(configuration: Configuration, requestFactory?: StorageManagementApiRequestFactory, responseProcessor?: StorageManagementApiResponseProcessor);
    /**
     ...
     */
    upsertSyncConfig(param: StorageManagementApiUpsertSyncConfigRequest, options?: Configuration): Promise<CloudInventorySyncConfigResponse>;
}
